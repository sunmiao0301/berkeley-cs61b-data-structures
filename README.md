...
- `git add ./ && git commit -m "xx" && git push` after finish your work on this repo
  ...
  - ```bash
    ...
    Fast-forward
     ...
     create mode 100644 Reading4.4.md
     create mode 100644 skeleton-sp19/library-sp19/data/words.txt
     create mode 100644 skeleton-sp19/library-sp19/javalib/algs4.jar
     create mode 100644 skeleton-sp19/library-sp19/javalib/hamcrest-core-1.3.jar
     create mode 100644 skeleton-sp19/library-sp19/javalib/jh61b.jar
     create mode 100644 skeleton-sp19/library-sp19/javalib/junit-4.12.jar
     create mode 100644 skeleton-sp19/library-sp19/javalib/stdlib-package.jar
     create mode 100644 skeleton-sp19/library-sp19/javalib/stdlib.jar
     create mode 100644 skeleton-sp19/library-sp19/javalib/xchart-3.5.1.jar
     create mode 100644 skeleton-sp19/proj1a/ArrayDeque.java
     create mode 100644 skeleton-sp19/proj1a/WordUtils.java
    ```

### why this

Foundation is important -- The Law of the Broken Futon. Fundamental dynamic data structures, including linear lists, queues, trees, and other linked structures; arrays strings, and hash tables. Storage management. Elementary principles of software engineering. Abstract data types. Algorithms for sorting and searching. Introduction to the Java programming language.
